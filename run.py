...
# Initialize Chrome OS support (if running on Chrome OS)
try:
    from modules.chrome_os import init_chrome_os_support
    init_chrome_os_support()
except ImportError:
    pass  # Chrome OS module not available, continue normally
