...
|---------|------|--------|----------|
| **Lite** | ~39KB | Built-in face-api.js | Low-end Chrome |
| **Mini** | ~38KB | Manual download (~250MB) | Full features |

### Lite vs Mini
- **Lite**: Uses face-api.js (no download needed). Smaller but lower quality.
- **Mini**: Uses ONNX models. Higher quality, requires model download.
